...
# blkparse
BLKPARSE_OUTPUT=${BLKTRACE_RESULT_PATH}/read-dtwin-output

# D2C extractor
D2C_extractor_PATH="/home/hkchoi/research/script/iod/D2C_extractor"
D2C_READ_OUTPUT=${BLKTRACE_RESULT_PATH}/read-dtwin-output-read
D2C_WRITE_OUTPUT=${BLKTRACE_RESULT_PATH}/read-dtwin-output-write
